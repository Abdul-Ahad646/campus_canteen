        ...
        <div class="row">
            ...
            <div class="col-md-4 order-md-2 mb-4">
                ...
                <h4 class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span class="badge badge-secondary badge-pill"><?=count($addCard)?></span>
                </h4>
                ...
                <ul class="list-group mb-3">
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div class="border-bottom border-2 border-black p-2">

                            <img alt="img" src="/product_image/{{ $product_image->product_image ?? ''}}"
                                style="width:50px; height:50px; " />
                            <small class="text-muted p-1">{{$card["name"]}} (Quantity:{{$card['quantity']}})</small>
                        </div>
                    ...
                    <li class="list-group-item d-flex justify-content-between ">
                        <span>Total (BDT)</span>
                        <strong>{{Cart::getSubTotal();}} TK</strong>
                ...
                <form method="POST" class="needs-validation" novalidate>
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="customer_name" value="{{Auth::user()->name ?? ''}}" class="form-control" id="customer_name"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{Auth::user()->address ?? ''}}"  id="address" placeholder="1234 Main St"
                             required>
                        <div class="invalid-feedback">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input type="hidden" class="custom-control-input" id="same-address">
                        <input type="hidden" value="{{Cart::getSubTotal();}}" name="amount" id="total_amount"
                            required />
